...
//            Toast.makeText(MainActivity.this, "You selected the setting menu",
//                    Toast.LENGTH_LONG).show();
            Snackbar.make(coordinatorLayout,
                    "You selected settings, Zin Maung ", Snackbar.LENGTH_LONG)
                    .setAction("Action", null).show();
            return true;
        }
    ...
    public void onStart() {
        ...
        Action viewAction = Action.newAction(
                ...
                Uri.parse("android-app://com.example.hsport.catalog/http/host/path")
        );
